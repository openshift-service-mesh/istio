...
if [[ "${ISTIO_ENVOY_BASE_URL}" != "https://storage.googleapis.com/istio-build/proxy" && "${ISTIO_ENVOY_BASE_URL}" != "https://storage.googleapis.com/maistra-prow-testing/proxy" ]]; then
